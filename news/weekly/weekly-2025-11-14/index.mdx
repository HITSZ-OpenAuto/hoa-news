...
draft: false
excludeSearch: false
title: AUTO 周报 2025-11-14 - 2025-11-21
---

## 本周更新摘要

- 复变函数与积分变换（MATH1005）：上传复变函数笔记，补充课程学习资料。
- 矩阵分析（MATH4001）：新课程上线并补充课件，已补完大部分定理证明。
- 新时代中国特色社会主义理论与实践（GEIP4004）：仓库创建并上线新课程（Initial commit）。
- 控制理论中的代数基础（AUTO2006）：更新了 2025 春季作业答案。
- 仓库管理与自动化（repos-management）：工作流与 CI 重构与强化——分离 workflow 内容、移除定时触发、加入手动触发与触发更新仓库列表的步骤、改用 GITHUB_TOKEN 并自动更新仓库列表等若干改进。
