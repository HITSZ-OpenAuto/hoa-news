...
draft: false
excludeSearch: false
title: AUTO 周报 2025-11-28 - 2025-12-05
---

## 本周更新摘要

- 最优估计 (AUTO5013)：新增 2024 年作业答案与 2025 年作业源文档。
- 数字逻辑设计 (COMP2051)：上传 2024 年期末试题个人解答。
- 优化算法 (MATH4002)：新课程仓库上线。
- 矩阵分析 (MATH4001)：更新了试题解析（题解/答案）。
- 概率论与数理统计 (MATH1004)：README 更新并合并 PR，新增 typst 模板仓库说明。
- 模式识别 (AUTO5024)：添加 2025 年试题。
- 电气专业选修课 (EE30XX)：新仓库创建并上线，补充了学时与成绩安排，添加了两位同学的课程评价。
- 电路与电子学 I (EE1018)：从 II 拆分为独立仓库并完成初始迁移；已将 OpenCS 中电工/电子相关资料迁移入该仓库，同时进行了课程信息与格式修正。
- 电路与电子学 (EE1013)：调整了 24 级电路与电子学 II 的内容，I 与 III 内容独立化。
